...
public class AnalisadorSintatico {
    ...
    private void tipoCond(){
        if(this.token.getClasse().equals(Classe.OPERADOR_RELACIONAL)){
            this.token = proximo_token();
            termo();
        }
    }
    ...
    private void tipoTermo() {
        ...
        if(pertenceAoPrimeiroDe("negar")){
            if (token.getClasse().equals(Classe.IDENTIFICADOR)) {
                this.token = proximo_token();
                vetor();
            }else{
                System.out.println("ERRO: aguarda-se um identificador");
                novoErro(this.token.getLinha(), "ERRO: aguarda-se um identificador");
                this.recuperacaoDeErro();
            }
            ...
            System.out.println("ERRO:numero ou Cadeia de caracter ou tipo booleano");
            novoErro(this.token.getLinha(), "ERRO:numero ou Cadeia de caracter ou tipo booleano");
            this.recuperacaoDeErro();
        }
    }
